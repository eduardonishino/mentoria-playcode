...
*******************************************************************************/
function calculaAnosAposentadoria(pessoa ,aposentar){
	
	let minimo;
	minimo = aposentar - pessoa;
	return (minimo);
}
...
*******************************************************************************/
function mostrarMensagem(pessoa,aposentadoria){
	
    
	return ("Faltam " + calculaAnosAposentadoria(pessoa,aposentadoria) + " anos para a sua aposentadoria");
...
let respostaTarefa9 = "Eu sei programar em Javascript";
