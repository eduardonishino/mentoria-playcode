...
function tabelaPeriodica(){
	const tabela = [{ Sigla: 'H', nome: 'hidrogênio', numeroAtomico: 1 },{ Sigla: 'He', nome: 'hélio', numeroAtomico: 2 },
	{ Sigla: 'Li', nome: 'lítio', numeroAtomico: 3 },{ Sigla: 'Be', nome: 'berílio', numeroAtomico: 4 },
